// scaling.cpp : Defines the entry point for the application.
//
...
scaling::scalingMain g_spinningCubeMain;
HWND g_hwnd{};
bool g_done = false;

int g_scaling_sourceWidth = 788;
int g_scaling_sourceHeight = 592;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   desiredClientRect.right = g_scaling_destWidth;
   desiredClientRect.bottom = g_scaling_destHeight;
